...
NOTE (refactor): file loading, alignment, and interpolation now come from the
shared `tropoe_shared` package instead of being defined locally. If it's not
already on your Python path (e.g. installed via TROPoe_outputs), adjust the
sys.path line below to point at wherever you keep it.
"""
